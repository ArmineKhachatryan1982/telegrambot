...
return [
    ...
    */
    'bots' => [
        ...
        'TestMessage' => [
            'token' => env('TELEGRAM_BOT_TOKEN', '7107824182:AAEpGRYcb1kMGvybkL8sG7tvFWYr0QqVfIw'),
            'certificate_path' => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url' => env('TELEGRAM_WEBHOOK_URL', 'https://telegrambot.webex.am/telegram/webhook'),
            /*
             * @see https://core.telegram.org/bots/api#update
             */
            'allowed_updates' => null,
